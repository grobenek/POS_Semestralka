...
int main(int argc, char* argv[])
{
    ...
    {
        Server server(10, 10138);
        server.createServer();
        server.serverRun();
    } else if (strcmp(argv[1], "client") == 0)
    {
        Client client;
        client.createConnection(10138, "localhost");
    }

    Svet* svet = nullptr;
    std::cout << "Press 'enter' to start the application." <<
              std::endl;
    std::cin.
    ...
    while (true)
    {
        ...
        switch (choice)
        {
            ...
            case 2:
                ...
                break;
            case 3:
                MenuControl::readInput(1, 2,

                                       MenuControl::displaySaveSimulation()
            ...
            case 4:
                MenuControl::readInput(1, 2,
                                       ...
                                       MenuControl::displayLoadSimulation()
